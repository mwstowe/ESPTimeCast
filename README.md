...
| **Temp**     | —          | ✅ Yes        | ✅ Yes         | 🏠 Indoor + 🌍 Outdoor (e.g. `I23º O18º`)      |
| **Temp**     | —          | ✅ Yes        | ❌ No          | 🏠 Indoor only (e.g. `In 23ºC`)              |
| **Temp**     | —          | ❌ No         | ✅ Yes         | 🌍 Outdoor only (e.g. `Out 18ºC`)            |
...
- In **Temperature** mode, you'll see indoor and/or outdoor temperatures depending on what's available:
  ...
  - If only indoor is available, it shows "In" followed by the temperature
  - If only outdoor is available, it shows "Out" followed by the temperature
